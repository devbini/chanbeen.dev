            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <main className="grid grid-cols-1 lg:grid-cols-4 gap-8 py-8">
                    ...
                    <div className="lg:col-span-3">
                        <div className="p-6 mb-8 rounded-lg border dark:border-gray-800 bg-white dark:bg-gray-900/50 shadow-sm flex items-center justify-between">
                            <h1 className="text-4xl font-bold text-gray-800 dark:text-gray-200">
                                Tag:{' '}
                                <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-pink-500 transition-all duration-300">
                                    #{originalTag}
                                </span>
                            </h1>
                        </div>
